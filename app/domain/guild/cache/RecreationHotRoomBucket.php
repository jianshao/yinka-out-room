...
class RecreationHotRoomBucket
{
    ...
    {
        return CachePrefix::$recreationHotRoomSortBucket;
    }

    /**
     * @param $resetList RecreationHotRoomCache[]
     * @return int  返回add的数量
     */
    ...
    public function store(RecreationHotRoomCache $itemModel, $score)
    {
        $cacheKey = $this->getBucketCacheKey();
