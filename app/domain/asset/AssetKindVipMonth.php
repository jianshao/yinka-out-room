...
class AssetKindVipMonth extends AssetKind
{
    ...
    public function add($userAssets, $count, $timestamp, $biEvent) {
        ...
        $expiresTime = $vip->getVipExpiresTime();
        ...
        Log::info(sprintf('AssetKindVipMonth.add userId=%d count=%d expiresTime=%d newExpires=%d days=%d',
            $userAssets->getUserId(), $count, $expiresTime, $newExpiresTime, $days));
        return $vip->addVip($days, $timestamp, $biEvent);
    }
