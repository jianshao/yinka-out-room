...
class HomeHotRoomModelDao
{
    ...
    public static function getInstance()
    {
        if (!isset(self::$instance)) {
            self::$instance = new HomeHotRoomModelDao();
        }
     ...
     * @return int
     */
    public function incGiftHotForBean($roomId, $isGuild, $value)
    {
        if (empty($roomId) || empty($value)) {
            return 0;
        }
        $value = $value * 10;
    ...
    {
        return sprintf("%s:%s", CachePrefix::$HomeRoomHot, $roomId);
    }
