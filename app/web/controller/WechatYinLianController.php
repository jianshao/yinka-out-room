...
class WechatYinLianController extends BaseController
{
    private $fromUsername;
    private $toUsername;
    private $times;
    private $keyword;
    private $app_id = 'wx3c65c973eb1d99e7';
    private $app_secret = 'a437fa7437afb879f0fa7cf8372b0733';
    private $EncodingAESKey = 'ODL2rpFA9rFkQqVw2zuNQgu2G7Ajt0PJIqregNhqHEv';
        ...
        $arr = array(
            'button' =>array(
                array(
                    'name'=>urlencode("下载"),
                    'type'=>'view',
                    'url'=>'https://newmapi2.jmyuyin.com/web/getUrl?type=2'
                ),
                array(
                    'name' => urlencode("产品相关"),
                    'sub_button' => array(
                        array(
                            'type' => 'view',
                            'name' => urlencode('公司官网'),
                            'url' => 'https://newmapi2.jmyuyin.com/web/getUrl?type=4'
                        ),
                        array(
                            'type' => 'view',
                            'name' => urlencode('公会招募'),
                ...
                array(
                    ...
                    'sub_button' => array(
                        array(
                            'type' => 'view',
                            'name' => urlencode('充值'),
                            'url' => 'https://newmapi2.jmyuyin.com/web/getUrl?type=1'
                        ),
                        array(
                            'type' => 'view',
                            'name' => urlencode('提现'),
                            'url' => 'https://newmapi2.jmyuyin.com/web/getUrl?type=3'
                        )
                    )
                )
            )
...
 
☞【&lt;a href=&quot;https://newmapi2.jmyuyin.com/web/getUrl?type=1&quot;&gt;官网充值&lt;/a&gt;】
☞提现服务请点击【&lt;a href=&quot;https://newmapi2.jmyuyin.com/web/getUrl?type=3&quot;&gt;提现&lt;/a&gt;】
                    ...
                    switch ($keyword)
                    {
                        case "充值";
                            $contentStr = "亲爱的小伙伴，应苹果政策要求，公众号菜单栏的iOS充值功能将暂时关闭（安卓用户不受影响），如需充值，请点击".
                                "【<a href='https://newmapi2.jmyuyin.com/web/getUrl?type=1'>充值链接</a>】"."进入官网，在官网中进行充值哦~
