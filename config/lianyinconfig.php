...
return array(
    ...
    'alipay_yuansheng'=>[
        ...
        'notify_url'=>'https://recodetest1.fqparty.com/api/v1/appalinotify',
        'redpacket_notify_url' => 'https://recodetest1.fqparty.com/api/v1/alipackets',
        'return_url'=>'',
	...
	'redpacket_notify_url'=>'http://fqparty.com/api/v1/wxpackets',
    ],

    'getui'=> [
        'appid' => 'Udnk7CqV3b64bK6kUdUtB9',
        'appkey' => 'LuP2ccWw6kAxxW047yYds5',
        'mastersecret' => 'PP9ETrk4pr6xBs7qR7KDX9',
        'host' => 'http://sdk.open.api.igexin.com/apiex.htm',
        'loginurl'=>'https://openapi-gy.getui.com/v1/gy/ct_login/gy_get_pn',
    ],
    'baseUrl2' => [
    	'online_url' => [
        	'api_url' => ['http://test1.php.fqparty.com'],
       		'py_url'  => ['http://test.py.fqparty.com/'],
        	'ws_url'  => ['ws://test.py.fqparty.com/ws'],
    	],
    	'test_url' =>  [
        	'api_url' => ['https://tsapi.jmyuyin.com ','https://tsapi.muayuyin.com', 'https://tsapi.rongqii.cn'],
        	'py_url'  => ['https://tspy.jmyuyin.com ','https://tspy.muayuyin.com', 'https://tspy.rongqii.cn'],
        	'ws_url'  => ['wss://tspy.jmyuyin.com/ws', 'wss://tspy.muayuyin.com/ws', 'wss://tspy.rongqii.cn/ws'],
    	],
    ],
);
